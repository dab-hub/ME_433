...
void APP_Tasks(void) {
    ...
    switch (appData.state) {
        ...
        case APP_STATE_MOUSE_EMULATE:
            ...
            float data5value = 10.0*data5/32767.0;
            signed char output5 = data5value;
            signed short data7 = ((input[13]<<8)|input[12]);
            float data7value = 10.0*data7/32767.0;
            signed char output7 = data7value;
                appData.mouseButton[0] = MOUSE_BUTTON_STATE_RELEASED;
                appData.mouseButton[1] = MOUSE_BUTTON_STATE_RELEASED;
                appData.xCoordinate = output5;
                appData.yCoordinate = -1*output7;
                vector++;
                movement_length = 0;
            }
